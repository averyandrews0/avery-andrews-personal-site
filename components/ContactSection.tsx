...
export function ContactSection() {
  return (
    <section id="contact" className="scroll-mt-24 bg-ink py-14 text-white sm:py-20">
      <div className="mx-auto grid max-w-6xl gap-8 px-5 sm:px-6 lg:grid-cols-[1fr_0.8fr] lg:px-8">
        ...
        <div className="rounded-lg border border-white/12 bg-white/6 p-5">
          <div className="space-y-3">
            <a
              href={links.email}
              className="flex items-center gap-3 rounded-md border border-white/12 bg-white/7 px-4 py-3 text-sm font-semibold text-white transition hover:bg-white/12"
            >
